#yarisma
> Multiplayer quiez game smlr to quizapp.

[![Build Status](https://travis-ci.org/sayawan/yarisma.svg?branch=master)](https://travis-ci.org/sayawan/yarisma) [![Dependency Status](https://david-dm.org/sayawan/yarisma.svg)](https://david-dm.org/sayawan/yarisma) [![devDependency Status](https://david-dm.org/sayawan/yarisma/dev-status.svg)](https://david-dm.org/sayawan/yarisma#info=devDependencies)
...
## Release History
 * 2015-02-08   v0.1.0   Generated by the [Yeoman Generator](https://github.com/FamousTools/generator-famous) for [Famo.us](http://famo.us)